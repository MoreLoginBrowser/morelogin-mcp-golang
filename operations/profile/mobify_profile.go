...
var ModifyProfileTool = func() mcp.Tool {
	...
	return mcp.NewTool(ModifyProfileToolName, options...)
}()

func ModifyProfileToolHandleFunc(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	apiUrl := fmt.Sprintf("/api/env/update")
